...
- 위치 설명용 기준 좌표를 선택 타일과 분리하여, 기준면 선택 전에도 기준면 기준 위·아래·왼쪽·오른쪽 위치를 읽을 수 있습니다.
...
- 위치 접근성 보완 커밋: `782443d7aed70c7fc668d50b528a45dbeaaf4852` (`fix: describe face positions from selected base`)
